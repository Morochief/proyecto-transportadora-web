...
class MIC(db.Model):
    ...
    campo_1_transporte = db.Column(db.Text)
    campo_2_numero = db.Column(db.String(30))
    campo_3_transporte = db.Column(db.Text)
    ...
    campo_7_pto_seguro = db.Column(db.Text)
    campo_8_destino = db.Column(db.Text)
    campo_9_datos_transporte = db.Column(db.Text)
    campo_10_numero = db.Column(db.String(30))
    campo_11_placa = db.Column(db.String(20))
    campo_12_modelo_chasis = db.Column(db.Text)
    ...
    campo_24_aduana = db.Column(db.Text)
    ...
    campo_30_tipo_bultos = db.Column(db.Text)
    campo_31_cantidad = db.Column(db.Numeric(10, 2))
    campo_32_peso_bruto = db.Column(db.Numeric(18, 3))
    campo_33_datos_campo1_crt = db.Column(db.Text)
    campo_34_datos_campo4_crt = db.Column(db.Text)
    campo_35_datos_campo6_crt = db.Column(db.Text)
    campo_36_factura_despacho = db.Column(db.Text)
    campo_37_valor_manual = db.Column(db.Text)
    campo_38_datos_campo11_crt = db.Column(db.Text)
    campo_40_tramo = db.Column(db.Text)
    chofer = db.Column(db.Text)
